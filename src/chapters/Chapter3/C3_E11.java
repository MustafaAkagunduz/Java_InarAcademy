...
public class C3_E11 {
	...
	System.out.println("Please enter the ordinal number of a month and the year(First number, then year)");
	int ordinalOfMonth=scn.nextInt();
	int year=scn.nextInt();
		...
		switch(ordinalOfMonth) {
		case 1: System.out.println("January "+ year+ " has 31 days");
				break;
		case 2: if(february==false) 
				{System.out.println("February "+ year+ " has 28 days");
				}else System.out.println("February "+ year+ " has 29 days"); 
				break;
